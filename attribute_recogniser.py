...
class AttributeRecogniser(object):
    ...
    def __init__(self, attr_list=[], model_temperature=0.1, hypothesis_momentum=0.9999, kl_tolerance=0.0, saved_model_dir=None, dqn_config: DQN_Config = None, show_graph=False, log_dir=None, exp_param=[], max_steps=100):
